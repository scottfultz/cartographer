...
interface TechSignature {
  ...
  patterns?: {
    html?: RegExp[];
    script?: RegExp[];
    meta?: Array<{ name: string; contentPattern?: RegExp }>;
    header?: Array<{ name: string; valuePattern?: RegExp }>;
    dom?: string[]; // Element selectors
  };
 ...
 */
export function detectTechStack(options: TechStackDetectorOptions): string[] {
 ...
 */
export function detectTechStackDetailed(options: TechStackDetectorOptions): Array<{
  name: string;
  category: string;
  certainty: 'high' | 'medium' | 'low';
}> {
