  ...
  personalDataPatterns.forEach(pattern => {
    $(pattern.selector).each((i, el) => {
      ...
      if (name === 'username' || name === 'email') {
        console.log(`[DEBUG] Pattern: ${pattern.selector}, Name: ${name}, UniqueKey: ${uniqueKey}, AlreadyHas: ${inputMap.has(uniqueKey)}`);
      }
      ...
      // DEBUG
      if (name === 'username' || name === 'email') {
        console.log(`[DEBUG] Name: ${name}, IsExcluded: ${isExcluded}`);
      }
