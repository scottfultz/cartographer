 ...
 * Tests for the completionReason logic without requiring full crawls
 */
...
function determineCompletionReason(ctx: CompletionContext): "finished" | "capped" | "error_budget" | "manual" {
