 ...
 */
export async function fetchUrl(cfg: EngineConfig, url: string): Promise<FetchResult> {
 ...
 */
async function performFetch(cfg: EngineConfig, url: string): Promise<FetchResult> {
  ...
  while (redirectCount <= maxRedirects) {
    ...
    const robotsHeader = headers["x-robots-tag"] as string | undefined;
