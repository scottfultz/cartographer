 ...
 */
export function normalizeUrlEnhanced(url: string, options: NormalizeOptions = {}): string {
  const {
    upgradeScheme = false,
    removeFragment = true,
 ...
 */
export function unicodeToPunycode(hostname: string): string {
  try {
 ...
 */
export function isHomographAttack(url: string): boolean {
  try {
