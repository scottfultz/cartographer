...
test("isInternal - same origin returns true", () => {
    assert.strictEqual(isInternal("https://caifrazier.com/page1", "https://caifrazier.com/page2"), true);
});
test("isInternal - different origin returns false", () => {
    assert.strictEqual(isInternal("https://caifrazier.com/page", "https://other.com/page"), false);
});
test("isSameOrigin - same origin", () => {
    assert.strictEqual(isSameOrigin("https://caifrazier.com/a", "https://caifrazier.com/b"), true);
});
test("isSameOrigin - different subdomain", () => {
    assert.strictEqual(isSameOrigin("https://www.caifrazier.com/a", "https://blog.caifrazier.com/b"), false);
});
...
test("sectionOf - multiple segments", () => {
    assert.strictEqual(sectionOf("https://caifrazier.com/products/shoes/nike"), "/products/");
});
test("sectionOf - with query and fragment", () => {
    assert.strictEqual(sectionOf("https://caifrazier.com/blog/post?id=1#section"), "/blog/");
});
